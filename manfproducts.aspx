<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/manfproducts.aspx.cs" Inherits="wholesale.manfproducts" %>
...
<head >
    ...
    <meta charset="utf-8" />
    <title> Inventory Report |Wholesale </title>
...
<asp:Button runat="server" ID="Load" Text="Load" OnClick="Load_Click" BackColor="Black" ForeColor="White" Font-Size="Large"/>
        ...
        <hr/>
          ...
          <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" ReportSourceID="CrystalReportSource1" Width="800" ToolPanelView="None" HasRefreshButton="True" HasCrystalLogo="False" />
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="manfProduct.rpt">
            </Report>
