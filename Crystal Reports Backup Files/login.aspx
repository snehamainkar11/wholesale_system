...
<head runat="server">
    ...
    <title>Waheguru Creation |Login</title>
                        ...
                        <form method="POST" runat="server" class="auto-style3">
                            ...
                            <div class="form-group">
                                <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                                  <asp:TextBox ID="txtpass1"  runat="server" TextMode="Password" ToolTip="Enter Password"  Placeholder="Password" Height="53px" Width="547px"></asp:TextBox>
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Password" ControlToValidate="txtpass1" ForeColor="red" Display="Dynamic"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-group">
                                ...
                                <asp:CheckBox ID="chk_remember" runat="server" name="remember-me" class="auto-term" Checked="True" Height="17px" Width="28px" />
                         Remember Me    
                       </div>
                            ...
                            <div class="form-group form-button">
                                ...
                                <asp:Button ID="signin" runat="server" class="form-submit" Text="Sign In" OnClick="signin_click" Height="47px" Width="163px"  />
