<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" MasterPageFile="~/adminmaster.Master" CodeBehind="purchaselist.aspx.cs" Inherits="wholesale.admin.purchaselist" %>
                    ...
                    <asp:GridView ID="gvpo" runat="server" ShowFooter="False" ShowHeaderWhenEmpty="true" DataKeyNames="po"  OnRowDeleting="gvpo_RowDeleting"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Date">
                                <ItemTemplate>
                                    <asp:Label ID="lblclr" runat="server"  Text='<%# Bind("odate", "{0:dd/MM/yyyy}") %>' Width="100px"></asp:Label>
                                </ItemTemplate>
