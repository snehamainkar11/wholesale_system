<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" MasterPageFile="~/adminmaster.Master"  CodeBehind="salesorder.aspx.cs" Inherits="wholesale.admin.salesorder" %>
                    ...
                    <asp:GridView ID="gvmaterial" runat="server" ShowFooter="True" ShowHeaderWhenEmpty="true" DataKeyNames="orderno"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Customer Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblbrd2" runat="server" Text='<%# Bind("cname") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Due Date">
                                <ItemTemplate>
                                    <asp:Label ID="lblclr" runat="server"  Text='<%# Bind("duedate", "{0:dd/MM/yyyy}") %>' Width="100px"></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Total Amount">
                                <ItemTemplate>
                                    <asp:Label ID="lblsm" runat="server" Text='<%# Bind("grand") %>'></asp:Label>
                                </ItemTemplate>

                                <EditItemTemplate>
                                    <asp:TextBox ID="total" CssClass="form-control" runat="server" Text='<%# Bind("grand") %>' Width="100px"></asp:TextBox>
                               ...
                               <asp:TemplateField HeaderText="Due Amount">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="due" CssClass="form-control" runat="server" Text='<%# Bind("due") %>' Width="100px"></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Payment Status">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblup" runat="server" Text='<%# Bind("status") %>'></asp:Label>
                                         </span>
                                </ItemTemplate>
                                <EditItemTemplate>
