<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="salesdata.aspx.cs" Inherits="wholesale.salesdata" %>
...
<asp:Button runat="server" ID="Load" Text="Load" OnClick="Load_Click" BackColor="Black" ForeColor="White" Font-Size="Large"/>
      &nbsp;   &nbsp;   &nbsp;   &nbsp;   &nbsp;   &nbsp;   &nbsp;   &nbsp;  <asp:HyperLink runat="server" ID="link" NavigateUrl="~/salesreport.aspx"  Text="Productwise report"/>    
        <hr/>
        
          <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" ReportSourceID="CrystalReportSource1" Width="902px" GroupTreeStyle-BackColor="White" HasRefreshButton="True" Height="1096px" ToolPanelWidth="" BorderStyle="Inset" HasCrystalLogo="False" ToolPanelView="None"  />
